...
public interface SaleRepository extends JpaRepository<SaleJpaEntity, Long> {
    ...
    List<SaleJpaEntity> findByIdEmployeeStore(Long idEmployeeStore);
    ...
    @Query("SELECT s FROM SaleJpaEntity s WHERE s.idEmployeeStore = :idEmployeeStore AND s.date BETWEEN :startDate AND :endDate")
    List<SaleJpaEntity> findByEmployeeStoreAndDateRange(@Param("idEmployeeStore") Long idEmployeeStore, 
                                                       @Param("startDate") LocalDateTime startDate, 
                                                       @Param("endDate") LocalDateTime endDate);
