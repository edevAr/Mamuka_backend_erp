...
public class ProductJpaEntity {
    ...
    public ProductJpaEntity(String name, String status, BigDecimal price, LocalDate expirationDate, String descripcion) {
        this.name = name;
        this.status = status;
        this.price = price;
        this.expirationDate = expirationDate;
    ...
    public ProductJpaEntity(Long idProduct, String name, String status, BigDecimal price, LocalDate expirationDate, String descripcion, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idProduct = idProduct;
        this.name = name;
        this.status = status;
        this.price = price;
