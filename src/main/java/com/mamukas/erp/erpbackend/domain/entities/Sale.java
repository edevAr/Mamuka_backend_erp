...
public class Sale {
    ...
    // Constructor with employee store
    public Sale(Long idProduct, Long idCustomer, Long idEmployeeStore, Integer amount, BigDecimal subtotal) {
        this();
        this.idProduct = idProduct;
        this.idCustomer = idCustomer;
    ...
    // Constructor with discount and employee store
    public Sale(Long idProduct, Long idCustomer, Long idEmployeeStore, Integer amount, BigDecimal subtotal, BigDecimal discount) {
        this(idProduct, idCustomer, idEmployeeStore, amount, subtotal);
        this.discount = discount != null ? discount : BigDecimal.ZERO;
        calculateTotal();
    }

    // Full constructor
    public Sale(Long idSale, LocalDateTime date, Long idProduct, Long idCustomer, Long idEmployeeStore,
