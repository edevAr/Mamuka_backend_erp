...
public class Pack {
    ...
    public Pack(Long idPack, Long idProduct, String name, LocalDate expirationDate, Integer units, Integer unitsPack, Integer stock, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idPack = idPack;
        this.idProduct = idProduct;
        this.name = name;
        this.expirationDate = expirationDate;
