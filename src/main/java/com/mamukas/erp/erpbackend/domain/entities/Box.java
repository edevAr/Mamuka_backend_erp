...
public class Box {
    ...
    public Box(Long idBox, Long idProduct, String name, LocalDate expirationDate, Integer units, Integer unitsBox, Integer stock, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idBox = idBox;
        this.idProduct = idProduct;
        this.name = name;
        this.expirationDate = expirationDate;
