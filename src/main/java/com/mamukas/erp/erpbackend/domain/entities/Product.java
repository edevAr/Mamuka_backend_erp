...
public class Product {
    ...
    public Product(String name, String status, BigDecimal price, LocalDate expirationDate, String descripcion) {
        this.name = name;
        this.status = status;
        this.price = price;
        this.expirationDate = expirationDate;
    ...
    public Product(Long idProduct, String name, String status, BigDecimal price, LocalDate expirationDate, String descripcion, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idProduct = idProduct;
        this.name = name;
        this.status = status;
        this.price = price;
