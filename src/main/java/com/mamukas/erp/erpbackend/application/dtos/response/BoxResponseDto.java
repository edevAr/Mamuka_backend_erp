...
public class BoxResponseDto {
    ...
    public BoxResponseDto(Long idBox, Long idProduct, String name, LocalDate expirationDate, Integer units, Integer unitsBox, Integer stock, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idBox = idBox;
