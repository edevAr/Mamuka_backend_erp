...
public class SaleRequestDto {
    ...
    public SaleRequestDto(Long idProduct, Long idCustomer, Long idEmployeeStore, Integer amount, BigDecimal subtotal) {
        this();
        this.idProduct = idProduct;
        this.idCustomer = idCustomer;
    ...
    public SaleRequestDto(Long idProduct, Long idCustomer, Long idEmployeeStore, Integer amount, 
                         BigDecimal subtotal, BigDecimal discount) {
