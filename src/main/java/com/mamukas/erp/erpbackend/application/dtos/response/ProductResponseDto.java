...
public class ProductResponseDto {
    ...
    public ProductResponseDto(Long idProduct, String name, String status, BigDecimal price, LocalDate expirationDate, Integer stock, String descripcion, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idProduct = idProduct;
        this.name = name;
        this.status = status;
        this.price = price;
