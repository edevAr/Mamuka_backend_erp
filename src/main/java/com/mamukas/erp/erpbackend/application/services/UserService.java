...
public class UserService {
     ...
     * @return UserWithRolesAndPermissionsResponseDto with user info, roles array, and permissions array
     * @throws IllegalArgumentException if user not found
     */
    @Transactional(readOnly = true)
    public com.mamukas.erp.erpbackend.application.dtos.response.UserWithRolesAndPermissionsResponseDto getUserWithRolesAndPermissions(Long idUser) {
        ...
        // Get roles (user has one role, but we return it as an array)
        ...
        if (user.getRoleId() != null) {
            try {
                ...
                // If error getting role, return empty array
            }
        }
        ...
        return new com.mamukas.erp.erpbackend.application.dtos.response.UserWithRolesAndPermissionsResponseDto(
            userDto,
            roles,
            permissions
        );
